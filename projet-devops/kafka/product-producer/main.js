...
//   const timeout = 60000; // Attendre 30 secondes
...
//   throw new Error('Kafka is not ready within the timeout');
// }
...
async function main() {
  ...
  try {
    // Attendre que Kafka soit prêt avant de continuer
    // await waitForKafka()
    ...
    console.error('Error while waiting for Kafka to be ready:', err)
    process.exit(1)
  }
}
